...
function PersonalPlants() {
  ...
  const [gardenDisplay, setGardenDisplay] = useState('flex')
  const [whishDisplay, setWishDisplay] = useState('flex')
  ...
  const plantas = [
    {
      ...
      description:
        "Anti-inflamatórioNatural das vias respiratórias, o agrião tem seu consumo bastante indicado para o tratamento das bronquites crônicas.",
    },
    {
      image:
      ...
      description:
        "Uma erva rica em óleos essenciais, como a cânfora e o limoneno. O alecrim é muito utilizado no preparo de compressas, ajudando a aliviar hematomas e contusões, além de diminuir as dores provenientes das doenças reumáticas e articulares.",
    },
    {
      image:
      ...
      description:
        "Usada, principalmente, em tratamento de problemas gastrointestNais. O óleo essencial da canela é rico em cNamaldeído, agindo como combatente de diversos fungos e microrganismos.",
    },
    {
      image:
        "https://images.tcdn.com.br/img/img_prod/799330/coentro_verdao_517_1_20200523134108.jpg",
      name: "Coentro",
      scientificName: "Coriandrum sativum",
      utility: ["Cólicas estomacais", "ansiedade"],
      description:
        "Ajuda no melhor funcinamento digestivo e alívio das cólicas estomacais. Isso é possível pelo fato dele ser fonte de mucilagens, substâncias que ajudam a mucosa do intestino e do estômago a ficar protegida. Seu uso também é indicado para controlar a ansiedade.  ",
    },
    {
      image:
    ...
    },
    {
      ...
      description:
        "É uma ótima opção para quando a refeição pesada cai mal, contribuindo para o aumento da produção de bile. ContribuiNa redução da taxa de açúcar no nosso sangue, além dela ser fonte de propriedades anti-úlcera e anti-inflamatórias, contribuindo no tratamento de artrites.",
    },
    {
      image:
    ...
    },
    {
      ...
      description:
        "Combate a coceira na garganta das crises de tosse e também úlceras gástricas. Anti-inflamatório e antisséptico, o alcaçuz é bastante utilizado no combate aos diversos problemas pulmonares, podendo ainda ser aplicado em casos de bronquite, artrite e reações alérgicas.",
    },
    {
      image:
  ...
  return (
    <PersonalGarden>
      ...
      <div className="div--MyGardens--area">
        <MyGarden open={GardenOpen} onClick={() =>{
          setGardenOpen(80)
          setWishOpen(12)
        ...
        <MyWish open={wishOpen}  onClick={() =>{
          setGardenOpen(12)
          setWishOpen(80)
        }}>
          <h4 className="MyWish--h4">Lista de Desejos</h4>
          <div className='div--MyWish--list' display={whishDisplay}>
            {plantas.map((plant, index) => {
